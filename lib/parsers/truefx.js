    ...
    stream = fs.createReadStream(filePath)
        ...
        .pipe(es.mapSync(function(line) {
            ...
            (function() {
                ...
                if (millisecondTicks.length && new Date(millisecondTick.timestamp).getMinutes() !== new Date(_.last(millisecondTicks).timestamp).getMinutes()) {
                    ...
                    var low = _.min(millisecondTicks, function(tick) {
                        return tick.mid;
                    }).mid;
