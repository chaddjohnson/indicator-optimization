...
function Prc(inputs, outputMap) {
    this.constructor = Prc;
    ...
    if (!inputs.degree) {
        throw 'No degree input parameter provided to study.';
    }
    if (!inputs.deviations) {
        throw 'No deviations input parameter provided to study.';
    }
}

// Create a copy of the Base "class" prototype for use in this "class."
Prc.prototype = Object.create(Base.prototype);

Prc.prototype.calculateRegression = function(values, degree) {
    var data = [];
...
Prc.prototype.calculateStandardDeviation = function(values) {
    var valuesCount = values.length;
    var sum = 0;
    var squaredSum = 0;
    var mean = 0.0;
